          ...
          return (
            <li key={href}>
              <Link
                ...
                onClick={() => vibrar()}
                className={cn(
                  "flex flex-col items-center gap-1 rounded-[20px] px-0.5 py-2 text-[10px] font-medium tracking-tight whitespace-nowrap transition-all duration-200 active:scale-90",
                  ativo ? "bg-white/[.08] text-white" : "text-neutral-400"
                )}
              >
                <Icone
                  className={cn("size-5 transition-transform duration-200", ativo && "scale-110 text-ciano")}
